$(document).ready(function () {
  ...
  const API_ROUTE = "/admin/vehicles";

  if (brandID) {
    if (typeID) {
      fetchOption(
        `${API_ROUTE}/vehicle_type/${brandID}`,
        "vehicle_type_id",
        ["vehicle_type_id"],
        typeID
      );
    } else {
      fetchOption(`${API_ROUTE}/vehicle_type/${brandID}`, "vehicle_type_id", [
        "vehicle_type_id",
      ]);
    }
  }
  ...
  if (typeID) {
    if (varietyID) {
      fetchOption(
        `${API_ROUTE}/vehicle_variety/${typeID}`,
        "vehicle_variety_id",
        ["vehicle_variety_id"],
        varietyID
      );
