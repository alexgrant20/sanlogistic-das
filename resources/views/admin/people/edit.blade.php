...
@section('container')
  <div class="page-content">
    ...
    <section class="container-fluid">
      <form action="{{ url("/admin/people/$person->id ") }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="mb-5">
              ...
              <div class="row g-2 mb-2">
                ...
                <div class="col-xl-12">
                  ...
                  <input class="form-control form-control-lg @error('full_address') is-invalid @enderror" type="text"
                    accept="full_address/*" name="full_address"
                    value="{{ old('full_address', $person->full_address) }}" id="full_address">
                  @error('full_address')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
            ...
            <div class="col-xl-6">
              ...
              <div class="mb-2">
                ...
                <input class="form-control form-control-lg @error('bpjs_kesehatan') is-invalid @enderror"
                  type="text" name="bpjs_kesehatan" id="bpjs_kesehatan"
