          ...
          <div class="row">
              ...
              <div class="row g-2 mb-2">
                ...
                <div class="col-xl-6">
                  ...
                  <input type="date" class="form-control form-control-lg @error('joined_at') is-invalid @enderror"
                    id="joined_at" name="joined_at" value="{{ old('joined_at') }}">
                  @error('joined_at')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-12">
                  ...
                  <input class="form-control form-control-lg @error('full_address') is-invalid @enderror" type="text"
                    accept="full_address/*" name="full_address" id="full_address">
                  @error('full_address')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
            ...
            <div class="col-xl-6">
              <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                ...
                <img src="" class="img-fluid rounded mw-100" style="max-height: 200px" id="image-preview"
        ...
        <div class="mb-5">
          ...
          <div class="row">
            ...
            <div class="col-xl-6">
              <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                style="background-color: transparent;">
                <img src="" class="img-fluid rounded mw-100" style="max-height: 200px" id="ktp_image-preview"
                  alt="" data-action="zoom">
              </div>
            </div>
        ...
        <div class="mb-5">
          ...
          <div class="row">
            ...
            <div class="col-xl-6">
              ...
              <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                style="background-color: transparent;">
                <img src="" class="img-fluid rounded mw-100" style="max-height: 200px" id="sim_image-preview"
                  alt="" data-action="zoom">
              </div>
          ...
          <div class="row">
            <div class="col-xl-6">
              ...
              <div class="mb-2">
                ...
                <input class="form-control form-control-lg @error('assurance_image') is-invalid @enderror"
                  type="file" accept="image/*" name="assurance_image" id="assurance_image"
                  onchange="previewImage('assurance_image')">
          ...
          <div class="row">
            <div class="col-xl-6">
              ...
              <div class="mb-2">
                ...
                <input class="form-control form-control-lg @error('bpjs_kesehatan') is-invalid @enderror"
                  type="text" name="bpjs_kesehatan" id="bpjs_kesehatan" value="{{ old('bpjs_kesehatan') }}">
