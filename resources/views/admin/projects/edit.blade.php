...
@section('container')
  <div class="page-content">
    ...
    <section class="container-fluid">
      <form action="{{ url("/admin/projects/$project->name") }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-5">
          <div class="row">
              ...
              <div class="row g-4 mb-2">
                ...
                <div class="col-xl-6">
                  ...
                  <select class='form-select form-select-lg  @error('company_id') is-invalid @enderror' name='company_id'
                    ...
                    @foreach ($customers as $customer)
                      @if ($customer->id == old('company_id', $project['company_id']))
                ...
                <div class="col-xl-6">
                  ...
                  <input type="date" class="form-control form-control-lg  @error('date_start') is-invalid @enderror" id=""
                    name="date_start" value="{{ old('date_start', $project['date_start']) }}" required>
                ...
                <div class="col-xl-6">
                  ...
                  <input type="date" class="form-control form-control-lg @error('date_end') is-invalid @enderror"
                    id="date_end" name="date_end" value="{{ old('date_end', $project['date_end']) }}" required>
            ...
            <div class="col-xl-6 d-flex flex-column">
              ...
              <textarea class="form-control form-control-lg flex-grow-1" id="catatan" name="catatan" aria-describedby="commentHelp">{{ old('catatan', $project['catatan']) }}</textarea>
