  ...
  <div class="page-content">
    ...
    <div class="bg-dash-dark-2 py-4">
      <div class="container-fluid">
        <h2 class="h5 mb-0">Edit Company</h2>
      </div>
    </div>
    <section class="container-fluid">
      <form action="/admin/companies/{{ $company->name }}" method="POST" enctype="multipart/form-data">
        @csrf
          ...
          <div class="row g-2 mb-2">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror"
                id="name" name="name" value="{{ old('name', $company->name) }}" autofocus>
            ...
            <div class="col-xl-4">
              ...
              <select class='form-select form-select-lg  @error('company_type_id') is-invalid @enderror'
                ...
                @foreach ($companies_types as $company_type)
                  @if ($company_type->id == old('company_type_id', $company->company_type_id))
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('website') is-invalid @enderror"
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('director') is-invalid @enderror"
                id="director" name="director" value="{{ old('director', $company->director) }}">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('npwp') is-invalid @enderror"
                id="npwp" name="npwp" value="{{ old('npwp', $company->npwp) }}">
              ...
              <div class="col-xl mt-5">
                <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                  ...
                  <img src="{{ asset('storage/' . ($siup['image'] ?? 'default/default.jpg')) }}"
                    class="img-fluid rounded zoom mw-100" style="max-height: 200px" id="siup_image-preview"
