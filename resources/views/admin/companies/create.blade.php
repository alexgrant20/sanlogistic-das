          ...
          <div class="row g-2 mb-2">
            ...
            <div class="col-xl-12">
              ...
              <input type="text" class="form-control form-control-lg @error('full_address') is-invalid @enderror"
                id="full_address" name="full_address" value="{{ old('full_address') }}">
            ...
            <div class="row g-2">
              ...
              <div class="col-xl mt-5">
                <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                  ...
                  <img class="img-fluid rounded zoom mw-100" style="max-height: 200px" id="siup_image-preview"
            ...
            <div class="row g-2">
              ...
              <div class="col-xl-6">
                ...
                <input type="text" class="form-control form-control-lg @error('sipa') is-invalid @enderror"
                  id="sipa" name="sipa" value="{{ old('sipa') }}">
              ...
              <div class="col-xl mt-5">
                <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                  style="background-color: transparent;">
                  <img src="" class="img-fluid rounded zoom mw-100" style="max-height: 200px"
                    id="sipa_image-preview" alt="" data-action="zoom">
                </div>
              </div>
