<div class="mb-5">
  ...
  <div class="row g-2">
    ...
    <div class="col-xl-3">
      ...
      <select class='form-select form-select-lg @error('area_id') is-invalid @enderror' name='area_id' id="area_id">
    ...
    <div class="col-xl-3">
      ...
      <select class='form-select form-select-lg  @error('address_type_id') is-invalid @enderror' name='address_type_id'
        id="address_type_id">
        <option hidden></option>
    ...
    <div class="col-xl-3">
      ...
      <div class="position-relative">
        <select class='form-select form-select-lg @error('city_id') is-invalid @enderror' name='city_id' id="city_id"
          disabled>
          <option hidden></option>
        </select>
    ...
    <div class="col-xl-3">
      ...
      <div class="position-relative">
        <select class='form-select form-select-lg @error('subdistrict_id') is-invalid @enderror' name='subdistrict_id'
          id="subdistrict_id" disabled>
          <option hidden></option>
        </select>
