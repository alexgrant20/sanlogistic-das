   ...
   <div class="row g-5">
      <div class="col-xl-6">
         <div class="row g-2 mb-2">
            ...
            <input type="hidden" id="variety_id"
               value="{{ old('vehicle_variety_id', $vehicle->vehicle_variety_id) }}">
            <div class="col-xl-6">
            ...
            <div class="col-xl-6">
               ...
               <input type="text"
                  class="form-control form-control-lg @error('engine_number') is-invalid @enderror"
            ...
            <div class="col-xl-4">
               ...
               <input type="text"
                  class="form-control form-control-lg @error('internal_code') is-invalid @enderror"
            ...
            <div class="col-xl-4">
               ...
               <input type="number"
                  class="form-control form-control-lg @error('maintenance_odo') is-invalid @enderror"
            ...
            <div class="col-xl-4">
               ...
               <input type="date"
                  class="form-control form-control-lg @error('maintenance_date') is-invalid @enderror"
   ...
   <div class="row g-5">
         ...
         <div class="row g-2">
            ...
            <div class="col-xl-6">
               ...
               <input type="text" class="form-control form-control-lg  @error('kir_number') is-invalid @enderror"
                  id="kir_number" name="kir_number"
                  value="{{ old('kir_number', $vehicleDocuments['kir']->number ?? null) }}">
               @error('kir_number')
                  <div class="invalid-feedback">
                     {{ $message }}
                  </div>
            ...
            <div class="col-xl-6">
               ...
               <input type="date" class="form-control form-control-lg @error('kir_expire') is-invalid @enderror"
                  id="kir_expire" name="kir_expire"
                  value="{{ old('kir_expire', $vehicleDocuments['kir']->expire ?? null) }}"
      ...
      <div class="col-xl-6">
         <div class="w-100 h-100 d-flex justify-content-center align-items-center"
            ...
            <img src="{{ asset('storage/' . ($vehicleDocuments['kir']->image ?? 'default/default.jpg')) }}"
...
<div class="mb-5">
   ...
   <div class="row g-5">
         ...
         <div class="row g-2">
            ...
            <div class="col-xl-6">
               ...
               <input type="text" class="form-control form-control-lg @error('stnk_number') is-invalid @enderror"
                  id="stnk_number" name="stnk_number"
                  value="{{ old('stnk_number', $vehicleDocuments['stnk']->number ?? null) }}">
               @error('stnk_number')
                  <div class="invalid-feedback">
                     {{ $message }}
                  </div>
            ...
            <div class="col-xl-6">
               ...
               <input type="date" class="form-control form-control-lg @error('stnk_expire') is-invalid @enderror"
                  id="stnk_expire" name="stnk_expire"
                  value="{{ old('stnk_expire', $vehicleDocuments['stnk']->expire ?? null) }}"
      ...
      <div class="col-xl-6">
         <div class="w-100 h-100 d-flex justify-content-center align-items-center"
            style="background-color: transparent;">
            <img src="{{ asset('storage/' . ($vehicleDocuments['stnk']->image ?? 'default/default.jpg')) }}"
               class="img-fluid rounded zoom mw-100" style="max-height: 200px" id="stnk_image-preview"
...
<div class="mb-5">
   <h4 class="text-primary fw-bold">MyPertamina</h4>
   <hr>
   <div class="row g-5">
      <div class="col-xl-6">
         <div class="row g-2">
            <div class="col-xl-12">
               <label for="mypertamina_image" class="form-label">QR MyPertamina</label>
               <input type="file" accept="image/*"
                  class="form-control form-control-lg @error('mypertamina_image') is-invalid @enderror"
                  id="mypertamina_image" name="mypertamina_image" accept="image/*"
                  onchange="previewImage('mypertamina_image')">
               @error('mypertamina_image')
                  <div class="invalid-feedback">
                     {{ $message }}
                  </div>
               @enderror
      ...
      <div class="col-xl-6">
         <div class="w-100 h-100 d-flex justify-content-center align-items-center"
            style="background-color: transparent;">
            <img src="{{ asset('storage/' . ($vehicleImages['mypertamina'] ?? 'default/default.jpg')) }}"
               class="img-fluid rounded zoom mw-100" style="max-height: 200px" id="mypertamina_image-preview"
               alt="" data-action="zoom">
         </div>
      </div>
   </div>
...
<div class="mb-5">
   ...
   <div class="row g-5">
      ...
      <div class="col-xl-4">
         ...
         @enderror
         <img src="{{ asset('storage/' . ($vehicleImages['front'] ?? 'default/default.jpg')) }}"
      ...
      <div class="col-xl-4">
         ...
         @enderror
         <img src="{{ asset('storage/' . ($vehicleImages['right'] ?? 'default/default.jpg')) }}"
      ...
      <div class="col-xl-4">
         ...
         @enderror
         <img src="{{ asset('storage/' . ($vehicleImages['back'] ?? 'default/default.jpg')) }}"
      ...
      <div class="col-xl-4">
         ...
         @enderror
         <img src="{{ asset('storage/' . ($vehicleImages['left'] ?? 'default/default.jpg')) }}"
