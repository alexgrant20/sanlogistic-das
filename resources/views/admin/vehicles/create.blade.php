    ...
    <section class="container-fluid">
      <form action="{{ route('admin.vehicle.store') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="row g-5">
            <div class="col-xl-6">
              <div class="row g-2 mb-2">
                ...
                <div class="col-xl-6">
                  ...
                  <select class='form-select form-select-lg @error('license_plate_color') is-invalid @enderror'
                    ...
                    @foreach ($vehiclesLPColors as $LPColor)
                      @if ($LPColor->id == old('vehicle_license_plate_color_id'))
                ...
                <div class="col-xl-6">
                  ...
                  <select class='form-select form-select-lg @error('vehicle_brand_id') is-invalid @enderror'
                    ...
                    @foreach ($vehiclesBrands as $vehicleBrand)
                      @if ($vehicleBrand->id == old('vehicle_brand_id'))
                ...
                <input type="hidden" id="type_id" value="{{ old('vehicle_type_id') }}">
                <div class="col-xl-6">
                ...
                <input type="hidden" id="variety_id" value="{{ old('vehicle_variety_id') }}">
                <div class="col-xl-6">
                ...
                <div class="col-xl-6">
                  ...
                  <select class='form-select form-select-lg  @error('vehicle_towing_id') is-invalid @enderror'
                    ...
                    @foreach ($vehiclesTowings as $vehicleTowing)
                      @if ($vehicleTowing->id == old('vehicle_towing_id'))
                ...
                <div class="col-xl-6">
                  ...
                  <input type="text" class="form-control form-control-lg @error('modification') is-invalid @enderror"
                    id="modification" name="modification" value="{{ old('modification') }}">
                  @error('modification')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-6">
                  ...
                  <input type="text" class="form-control form-control-lg @error('frame_number') is-invalid @enderror"
                    id="frame_number" name="frame_number" value="{{ old('frame_number') }}">
                  @error('frame_number')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-4">
                  ...
                  <input type="number" class="form-control form-control-lg @error('wheel') is-invalid @enderror"
                    id="wheel" name="wheel" value="{{ old('wheel') }}">
                  @error('wheel')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-4">
                  ...
                  <input type="number" min="1900" max="2099" step="1"
                    ...
                    id="registration_year" name="registration_year" value="{{ old('registration_year') }}">
                ...
                <div class="col-xl-4">
                  ...
                  <input type="number" class="form-control form-control-lg @error('odo') is-invalid @enderror" id="odo"
                    name="odo" value="{{ old('odo') }}">
                  @error('odo')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
          ...
          <div class="row g-5">
              ...
              <div class="row g-2">
                ...
                <div class="col-xl-6">
                  ...
                  <input type="text" class="form-control form-control-lg  @error('kir_number') is-invalid @enderror"
                    id="kir_number" name="kir_number" value="{{ old('kir_number') }}">
                  @error('kir_number')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-6">
                  ...
                  <input type="date" class="form-control form-control-lg @error('kir_expire') is-invalid @enderror"
                    id="kir_expire" name="kir_expire" value="{{ old('kir_expire') }}"
            ...
            <div class="col-xl-6">
              <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                ...
                <img src="" class="img-fluid rounded zoom mw-100" style="max-height: 200px" id="kir_image-preview" alt=""
                  data-action="zoom">
              </div>
            </div>
          </div>
        ...
        <div class="mb-5">
          ...
          <div class="row g-5">
              ...
              <div class="row g-2">
                ...
                <div class="col-xl-6">
                  ...
                  <input type="text" class="form-control form-control-lg @error('stnk_number') is-invalid @enderror"
                    id="stnk_number" name="stnk_number" value="{{ old('stnk_number') }}">
                  @error('stnk_number')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-6">
                  ...
                  <input type="date" class="form-control form-control-lg @error('stnk_expire') is-invalid @enderror"
                    id="stnk_expire" name="stnk_expire" value="{{ old('stnk_expire') }}"
            ...
            <div class="col-xl-6">
              <div class="w-100 h-100 d-flex justify-content-center align-items-center"
                style="background-color: transparent;">
                <img src="" class="img-fluid rounded zoom mw-100" style="max-height: 200px" id="stnk_image-preview"
        ...
        <div class="mb-5">
          ...
          <div class="row g-5">
            ...
            <div class="col-xl-4">
              ...
              @enderror
              <img src="" class="img-fluid rounded zoom mw-100 mx-auto d-block" style="max-height: 200px"
                id="front_image-preview" alt="" data-action="zoom">
            </div>
            ...
            <div class="col-xl-4">
              ...
              @enderror
              <img src="" class="img-fluid rounded zoom mw-100 mx-auto d-block" style="max-height: 200px"
                id="right_image-preview" alt="" data-action="zoom">
            </div>
            ...
            <div class="col-xl-4">
              ...
              @enderror
              <img src="" class="img-fluid rounded zoom mw-100 mx-auto d-block" style="max-height: 200px"
                id="back_image-preview" alt="" data-action="zoom">
            </div>
            ...
            <div class="col-xl-4">
              ...
              @enderror
              <img src="" class="img-fluid rounded zoom mw-100 mx-auto d-block" style="max-height: 200px"
                id="left_image-preview" alt="" data-action="zoom">
            </div>
        ...
        <div class="col-xl-6 d-flex flex-column mb-3">
          ...
          <textarea class="form-control form-control-lg flex-grow-1" id="note" name="note">{{ old('note') }}</textarea>
        </div>
