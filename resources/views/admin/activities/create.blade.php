          ...
          <div class="row g-2 mb-2">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('do_number') is-invalid @enderror"
                id="do_number" name="do_number" value="{{ old('do_number') }}">
            ...
            <div class="col-xl-4">
              ...
              <input type="number" class="form-control form-control-lg @error('departure_odo') is-invalid @enderror"
                id="departure_odo" name="departure_odo" value="{{ old('departure_odo') }}">
            ...
            <div class="col-xl-4">
              ...
              <select class='form-select form-select-lg @error('departure_location_id') is-invalid @enderror'
                ...
                @foreach ($addresses as $address)
                  @if ($address->id == old('departure_location_id'))
            ...
            <div class="col-xl-4">
              ...
              <select class='form-select form-select-lg @error('arrival_location_id') is-invalid @enderror'
                ...
                <option value='' hidden></option>
                @foreach ($addresses as $address)
                  @if ($address->id == old('arrival_location_id'))
                    <option value="{{ $address->id }}" selected>{{ $address->name }}</option>
                  @else
                    <option value="{{ $address->id }}">{{ $address->name }}</option>
                  @endif
            ...
            <div class="col-xl-4">
              ...
              <input type="date" class="form-control form-control-lg @error('do_date') is-invalid @enderror"
                id="do_date" name="do_date" value="{{ old('do_date') }}">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('bbm_amount') is-invalid @enderror"
                id="bbm_amount" name="bbm_amount" value="{{ old('bbm_amount') }}" data="money">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('toll_amount') is-invalid @enderror"
                id="toll_amount" name="toll_amount" value="{{ old('toll_amount') }}" data="money">
            ...
            <div class="col-xl-4">
              ...
              <input type="text"
                class="form-control form-control-lg @error('retribution_amount') is-invalid @enderror"
                id="retribution_amount" name="retribution_amount" value="{{ old('retribution_amount') }}"
                data="money">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('parking') is-invalid @enderror"
                id="parking" name="parking" value="{{ old('parking') }}" data="money">
          ...
          <div class="row g-2 mb-2">
            ...
            <div class="col-xl-4">
              ...
              <img src="" class="img-fluid rounded zoom mw-100 mx-auto d-block" style="max-height: 200px"
                id="do_image-preview" alt="" data-action="zoom">
            </div>
