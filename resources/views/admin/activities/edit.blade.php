          ...
          <div class="row g-2 mb-2">
            ...
            <div class="col-xl-4">
              ...
              <input type="datetime-local"
                ...
                name="arrival_date"
                value="{{ old('arrival_date', date('Y-m-d\TH:i:s', strtotime($activity['arrival_date']))) }}"
                step="1">
            ...
            <div class="col-xl-4">
              ...
              <input type="date" class="form-control form-control-lg @error('do_date') is-invalid @enderror"
                id="do_date" name="do_date" value="{{ old('do_date', $activity['do_date']) }}">
            ...
            <div class="col-xl-4">
              ...
              <input type="text"
                ...
                value="{{ old('retribution_amount', $activity->activityStatus->activityPayment->retribution_amount ?? null) }}"
                data="money">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('parking') is-invalid @enderror"
                ...
                value="{{ old('parking', $activity->activityStatus->activityPayment->parking_amount ?? null) }}"
                data="money">
