...
@section('container')
  <div class="page-content">
    ...
    <section class="container-fluid">
      ...
      <form action="{{ url("/finances/acceptance/$activity->id") }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-5">
          ...
          <div class="row g-2 mb-5">
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('bbm_amount') is-invalid @enderror"
                id="bbm_amount" name="bbm_amount" value="{{ old('bbm_amount', $activity->bbm_amount) }}" data="money">
