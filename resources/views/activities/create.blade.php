...
@section('container')
  <div class="page-content">
    ...
    <section class="container-fluid">
      ...
      <form action="{{ url('/activities') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-5">
          ...
          <div class="row g-2 mb-2">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('retribution_amount') is-invalid @enderror"
                id="retribution_amount" name="retribution_amount" value="{{ old('retribution_amount') }}" data="money">
            ...
            <div class="col-xl-4">
              ...
              <input type="text" class="form-control form-control-lg @error('parking') is-invalid @enderror" id="parking"
                name="parking" value="{{ old('parking') }}" data="money">
