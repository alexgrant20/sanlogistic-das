...
@section('container')
  <div class="page-content">
    ...
    <section class="container-fluid">
      ...
      <form action="/companies/{{ $company->name }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-xl-4">
              ...
              <select class='form-select form-select-lg @error('address_id') is-invalid @enderror' name='address_id'>
                ...
                @foreach ($addresses as $address)
                  @if ($address->id == old('address_id', $company->address_id))
            ...
            <div class="row g-2">
              ...
              <div class="col-xl-6">
                ...
                <input type="text" class="form-control form-control-lg  @error('siup') is-invalid @enderror" id="siup"
                  name="siup" value="{{ old('siup', $siup['number'] ?? null) }}">
            ...
            <div class="row g-2">
              ...
              <div class="col-xl-6">
                ...
                <input type="text" class="form-control form-control-lg @error('sipa') is-invalid @enderror" id="sipa"
                  name="sipa" value="{{ old('sipa', $sipa['number'] ?? null) }}">
