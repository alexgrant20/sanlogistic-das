            ...
            <div class="col-xl-6">
              <div class="row g-2 mb-2">
                ...
                <div class="col-xl-6">
                  ...
                  <select class='form-select form-select-lg @error('vehicle_brand_id') is-invalid @enderror'
                    ...
                    @foreach ($vehiclesBrands as $vehicleBrand)
                      @if ($vehicleBrand->id == old('vehicle_brand_id', $vehicle->vehicleVariety->vehicleType->vehicleBrand->id))
                ...
                <input type="hidden" id="type_id"
                  value="{{ old('vehicle_type_id', $vehicle->vehicleVariety->vehicleType->id) }}">
                <div class="col-xl-6">
                ...
                <div class="col-xl-4">
                  ...
                  <input type="number" class="form-control form-control-lg @error('odo') is-invalid @enderror" id="odo"
                    name="odo" value="{{ old('odo', $vehicle->odo) }}">
                  @error('odo')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="row g-2">
                ...
                <div class="col-xl-6">
                  ...
                  <input type="text" class="form-control form-control-lg  @error('kir_number') is-invalid @enderror"
                    id="kir_number" name="kir_number" value="{{ old('kir_number', $kir->number) }}">
                  @error('kir_number')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-6">
                  ...
                  <input type="date" class="form-control form-control-lg @error('kir_expire') is-invalid @enderror"
                    id="kir_expire" name="kir_expire" value="{{ old('kir_expire', $kir->expire) }}"
              ...
              <div class="row g-2">
                ...
                <div class="col-xl-6">
                  ...
                  <input type="text" class="form-control form-control-lg @error('stnk_number') is-invalid @enderror"
                    id="stnk_number" name="stnk_number" value="{{ old('stnk_number', $stnk->number) }}">
                  @error('stnk_number')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="col-xl-6">
                  ...
                  <input type="date" class="form-control form-control-lg @error('stnk_expire') is-invalid @enderror"
                    id="stnk_expire" name="stnk_expire" value="{{ old('stnk_expire', $stnk->expire) }}"
