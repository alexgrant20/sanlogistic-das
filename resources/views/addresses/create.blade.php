      ...
      <form action="{{ url('/addresses') }}" method="POST">
        ...
        <div class="mb-5">
          ...
          <div class="row g-2">
            ...
            <div class="col-xl-3">
              ...
              <select class='form-select form-select-lg @error('pool_type_id') is-invalid @enderror' name='pool_type_id'
                ...
                @foreach ($pool_types as $pool_type)
                  @if ($pool_type->id == old('pool_type_id'))
            ...
            <div class="col-xl-3">
              ...
              <select class='form-select form-select-lg  @error('address_type_id') is-invalid @enderror'
                ...
                @foreach ($address_types as $type)
                  @if ($type->id == old('address_type_id'))
            ...
            <input type="hidden" id="ci_id" value="{{ old('city_id') }}">
            <div class="col-xl-3">
            ...
            <input type="hidden" id="su_id" value="{{ old('subdistrict_id') }}">
            <div class="col-xl-3">
            ...
            <div class="col-xl-10">
              ...
              <input class="form-control form-control-lg @error('full_address') is-invalid @enderror" type="text"
                name="full_address" id="full_address" value="{{ old('full_address') }}">
              @error('full_address')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="col-xl-2">
              ...
              <input class="form-control form-control-lg @error('post_number') is-invalid @enderror" type="number"
                name="post_number" id="post_number" value="{{ old('post_number') }}">
              @error('post_number')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
