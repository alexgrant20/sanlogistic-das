  ...
  <section>
    <div class="row row-cols-sm-2 row-cols-xxl-4 gx-5 gy-4">
      @php
        ...
        $activityDesc = $activityId ? 'Buatlah Aktivitas Mengendarai Anda Disini' : 'Akhiri Aktivitas Mengendarai Anda Disini';
        $activityLabel = $activityId ? 'Buat Aktivitas' : 'Selesaikan Aktivitas';
