   ...
   <section>
      <div class="row row-cols-sm-2 row-cols-xxl-4 gx-5 gy-4">
         ...
         @can('activity-create')
            ...
            {{-- Location --}}
            <x-ui.menu-item backgroundColor="bg-primary" icon="fa-solid fa-motorcycle" :label="__('Gojek')"
               description="Only use if using ojek" :link="route('driver.activity.create-gojek')" />
